...
class SellerFranchiseComponent extends Component
{
    ...
    public function render()
    {
         ...
         $tryin = Brand::where('user_id',$user->id)->get();
        
        return view('livewire.seller.seller-franchise-component',[ 'pattribute' => $pattribute, 'city' => $city, 'local' => $local,'tryin' => $tryin])->layout('layouts.admin');
    }
}
