...
<img src="{{asset ('assets/images/img-v-2.jpg') }}" alt="Image" class="img-as-bg">
...
<input type="email" class="form-control"  name="email" placeholder="team@theexhibition.space" :value="old('email')" required autofocus>
</div></div>
...
<img src="{{asset ('front/coi_linkedin.svg') }}" alt="Image placeholder"></span><span class="btn-inner--text">Linkedin</span></a></div>
<div class="col-sm-6"><a href="#" class="btn btn-block btn-neutral btn-icon"><span class="btn-inner--icon">
<img src="{{asset ('assets/images/google.svg') }}"   alt="Image placeholder"></span>
<span class="btn-inner--text">Google</span></a></div></div>
