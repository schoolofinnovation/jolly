...
<img src="{{asset ('assets/images/img-v-2.jpg') }}" alt="Image" class="img-as-bg"><div class="row position-relative zindex-110 p-5">
...
<input type="text" class="form-control form-control-prepend" name="name" :value="old('name')" required autofocus autocomplete="name" placeholder="Full Name ">
...
<input type="email" class="form-control form-control-prepend"  name="email" :value="old('email')" required placeholder="hello@theexhibition.space">
...
<img src="{{asset('front/coi_linkedin.svg')}}" alt="login">
</span>
...
<img src="{{asset('assets/images/google.svg') }}" alt="login"></span>
