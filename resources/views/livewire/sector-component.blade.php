          ...
          <div class="order-lg-2 mb-3 mb-lg-0 pt-lg-2">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb breadcrumb-light flex-lg-nowrap justify-content-center justify-content-lg-start">
                ...
                <li class="breadcrumb-item text-nowrap"><a href="#">Franchise Opportunity</a>
                </li>
            ...
            @foreach ($franchises as $franchise)
              ...
              <a class="btn-wishlist btn-sm" type="button" href="" wire:click.prevent="removefromWishlist({{$franchise->id}})" data-bs-toggle="tooltip" data-bs-placement="left" title="" data-bs-original-title="Add to wishlist" aria-label="Add to wishlist">
                ...
                @endif
                  ...
                  <a class="product-meta d-block fs-xs pb-1" href="{{route('franchise.details',['slug' => $franchise->slug])}}">{{$franchise->category->service}}{{$franchise->category->industry}}</a>
