...
<main>
      ...
      <section class="container bg-faded-info mt-1 mb-grid-gutter">
            ...
            <div class=" col-md-8 d-none d-sm-block">
              <div class="d-flex my-Slider1">
                    ...
                    @foreach ($franchises as $franchise)
                      <div class="col-lg-4 col-md-4 col-sm-6 px-1 mb-1">
                        <div class="card product-card">
                          <a class="card-img-top d-block overflow-hidden" href="{{route('franchise.details',['slug' => $franchise->slug])}}">
                            <img src="{{url('public/storage/brands/'.$franchise->image)}}" alt="{{Str::limit($franchise->brand_name, 24)}}">
                          </a> 
                        </div>
                      </div>
                    @endforeach
      ...
      <!--listo-->
       <section class="d-sm-none">
            <div class="d-flex  align-items-center my-Slider90">
      ...
      <section class="container">
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center pt-1 border-bottom pb-4 mb-4">
          <div class="h4 widget-title fw-bolder mb-0 pt-3 me-2"><i class="bi bi-globe2"  width="164" height="164"></i> Trending Opportunities</div>
          <div class="pt-3"><a class="btn btn-outline-accent btn-sm" href="{{route('franchise.Coi')}}">More <span class="d-none">Opportunities</span><i class="bi bi-chevron-right ms-1 me-n1"></i></a></div>
        </div>
        ...
        <div class="row pt-2 mx-n2 my-Slider6">
              ...
              @foreach ($franchises as $franchise)
                <!-- Product-->
                <div class="col-lg-3 col-md-4 col-sm-6 px-3 mb-4">
                  <div class="card product-card">
                    <div class="product-card-actions d-flex align-items-center">
      ...
      <!-- Promo banner-->
      <section class=" container mt-2 mb-grid-gutter">
      ...
      <section class="container pt-2">
        <!-- Heading-->
        <div class="d-flex flex-wrap justify-content-between align-items-center pt-1 border-bottom pb-4 mb-4">
          <div class="h3 widget-title fw-bolder mb-0 pt-3 me-2">Demanding Opportunities</div>  
        <div class="pt-3"><a class="btn btn-outline-accent btn-sm" href="">More <span class="d-none">Opportunities</span><i class=" bi bi-chevron-right ms-1 me-n1"></i></a></div>
        </div>
       ...
       <!-- Grid-->
        <div class="row pt-2 mx-n2 my-Slider9">
          ...
          <div class="col-lg-3 col-md-4 col-sm-6 px-2 mb-4">
            <div class="card product-card">
              ...
              <a class="card-img-top d-block overflow-hidden" href="{{route('franchise.details',['slug' => $franchise->slug])}}">
              <img src="{{url('public/storage/brands/'.$franchise->image)}}" alt="{{Str::limit($franchise->brand_name, 24)}}"></a>
              <div class="card-body py-2">
              <a class="product-meta d-block fs-xs pb-1" href="{{route('franchise.details',['slug' => $franchise->slug])}}">{{$franchise->category->industry}}</a>
              ...
              <div class="widget">
                ...
                @foreach ($new as $franchise)<!--border-bottom-->
                  <div class="d-flex align-items-center pb-2 ">
                    ...
                    <img src="{{url('public/storage/brands/'.$franchise->image)}}" width="64" alt="{{Str::limit($franchise->brand_name, 24)}}"></a>
                      <div class="ps-2">
                        <h6 class="widget-product-title"><a href="{{route('franchise.details',['slug' => $franchise->slug])}}">{{Str::limit($franchise->brand_name, 24)}}</a></h6>
                        <div class="widget-product-meta"><span class="text-accent">{{$franchise->id}} | {{$franchise->max_investment}} - {{$franchise->min_investment}} lacs.</span></div>
                      </div>
                  </div>
                @endforeach
        ...
        <section class="container pt-2">
          <!-- Heading-->
          <div class="d-flex flex-wrap justify-content-between align-items-center pt-1 border-bottom pb-4 mb-4">
            <h2 class="h3 widget-title fw-bolder mb-0 pt-3 me-2">Dealer & Distribution Opportunities</h2>
            <div class="pt-3"><a class="btn btn-outline-accent btn-sm" href="">More <span class="d-none">Opportunities</span><i class=" bi bi-chevron-right ms-1 me-n1"></i></a></div>
          </div>
                  ...
                  @foreach($evento as $eventoi)
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-6 px-1 mb-1">
                      ...
                      <a class="card-img-top d-block overflow-hidden" href="http://127.0.0.1:8000/franchise/in-asperiores-quod-nam">
                        <img src="public/storage/brands/digital_8.png" alt="in asperiores quod nam"></a>

                      <div class="card-body py-2">
                        <a class="product-meta d-block fs-xs pb-1" href="/franchise/in-asperiores-quod-nam"></a>
