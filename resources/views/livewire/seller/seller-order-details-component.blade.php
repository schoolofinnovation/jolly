                      ...
                      <li class=" border-bottom">
                        @foreach($order->orderItems as $fun)
                          <div class="d-flex justify-content-between pb-2">
                            <span class="text-muted"> {{$fun->id}} {{ucwords(trans($fun->franchise->brand_name))}} :</span>
                            <span>{{$fun->franchise->max_investment}} x {{$fun->quantity}} Unit  :: {{$fun->franchise->max_investment * $fun->quantity}}</span> 
                          </div>
                        @endforeach
                      </li>
                      @if($order->discount > 0)
