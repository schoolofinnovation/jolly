...
<footer class="footer bg-dark pt-5 ">
      <div class="container">
        <div class="row pb-2">
          ...
          <div class="col-md-4 col-sm-6">
            ...
            <p class="fs-sm text-white opacity-70 pb-1">High quality  created by our global community.</p>
    ...
    <div class="handheld-toolbar">
      <div class="d-table table-layout-fixed w-100">
        ...
        <span class="handheld-toolbar-icon"><i class="bi bi-menu"></i></span><span class="handheld-toolbar-label">Menu</span></a>
        
        <a class="d-table-cell handheld-toolbar-item" href="">
        <span class="handheld-toolbar-icon"><i class="bi bi-cart"></i><span class="badge bg-primary rounded-pill ms-1">4</span></span>
