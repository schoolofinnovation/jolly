...
@section('page_description','Coupon')
...
@section('page_name',' All Coupon')
@section('page_path',' Coupon')
@section('page_list',' addCoupon')
        ...
        <div class="d-none d-lg-flex justify-content-between align-items-center pt-lg-3 pb-4 pb-lg-5 mb-lg-3">
          <div class="text-sm-end">
            <a class="btn btn-primary" href="{{route ('admin.categories')}}" data-bs-toggle="modal">  All Coupon </a></div>
                ...
                <div class="fs-base text-light mb-0"> {{Session::get('message')}} </div>
                @endif
